...
analyze   Run the full pipeline (normalize → DTW → score → feedback) on a pair.
...
--------
  ...
  python main.py analyze --benchmark data/phrase_01/keypoints/benchmark_kp.npy \
                         ...
                         --fps 30 --out results/phrase_01/
  python main.py batch --data data/ --fps 30 --out results/
"""
